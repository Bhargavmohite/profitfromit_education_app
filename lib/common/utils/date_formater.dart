...
String timeStampToDateHourAMPM(int timeStamp,{bool isUtc=false}) => DateFormat('d MMM y  hh:mm aa', locator<AppLanguage>().currentLanguage).format(DateTime.fromMillisecondsSinceEpoch(timeStamp, isUtc: isUtc));
