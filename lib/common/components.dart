...
Widget courseItemVerticallyCartPage(CourseModel courseData,
      ...
      Theme(
        ...
        child: SizedBox(
          ...
          child: TextFormField(
            ...
            focusNode: node,
            cursorColor: green50,
            cursorHeight: obscureText ? 10 : 15,
            readOnly: isReadOnly,
            onTap: () {
              if (onTap != null) {
                onTap();
            ...
            decoration: InputDecoration(
              ...
              suffixIconConstraints: const BoxConstraints.expand(width: 50),
                ...
                AnimatedPositionedDirectional(
                  ...
                  child: AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                        ...
                        color: state ? green77() : greyE7,
                        boxShadow: [
                          boxShadow(greyD0.withValues(alpha: .4),
                              blur: 10, y: 3)
                        ]),
                  ),
                ),
      ...
      children: [
        AnimatedContainer(
          ...
          decoration: BoxDecoration(
              ...
              color: state ? green77() : greyE7,
              boxShadow: [
                boxShadow(greyD0.withValues(alpha: .38), blur: 10, y: 3)
              ]),
        ),
        space(0, width: 8),
        Text(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                  ...
                  color: user.meetingStatus == 'no'
                      ? red49.withValues(alpha: .3)
                      : user.meetingStatus == 'available'
                          ? green77().withValues(alpha: .3)
                          : greyCF.withValues(alpha: .3)),
              alignment: Alignment.center,
              child: SvgPicture.asset(
                AppAssets.calendarSvg,
                width: 11,
    ...
    child: Container(
      ...
      child: Column(
        ...
        children: [
          ...
          HtmlWidget(
            blog.description ?? '',
            textStyle: style12Regular().copyWith(
              color: greyA5,
              height: 1.6,
            ),
          ),
          ...
          Wrap(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  SvgPicture.asset(
                    AppAssets.commentSvg,
                  ),
                  space(0, width: 5),
                  Text(
                    '${blog.commentCount ?? 0} ${appText.comments}',
                    style: style10Regular().copyWith(
                      color: greyA5,
                    ),
                  ),
              ...
              Row(
                ...
                children: [
                  ...
                  Text(
                    '${blog.blogCount ?? 0} '
                    '${(blog.blogCount ?? 0) <= 1 ? appText.view : "Views"}',
                    style: style10Regular().copyWith(
                      color: greyA5,
                    ),
                  ),
              ...
              InkWell(
                onTap: () {
                  final String link =
                      "https://profitfromit.co.in/blog/${blog.id}";
                  ...
                  if (Platform.isIOS) {
                    ...
                    final String shareMsg = "${blog.title ?? ''}\n\n$link";
...
Widget clickableDashboardInfoBox(Color color, String icon, String title,
      ...
      Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Divider(color: grey3A.withValues(alpha: .15), thickness: .3),
...
Future downloadSheet(String downloadUrl, String name,
  ...
  debugPrint("Download url for content ============> $downloadUrl");
  debugPrint("Download url for content File name ============> $name");
      ...
      child: Column(
        ...
        children: [
          ...
          LinearProgressIndicator(
            backgroundColor: green77().withValues(alpha: .2),
            value: progress,
