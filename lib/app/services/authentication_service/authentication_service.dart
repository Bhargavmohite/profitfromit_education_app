...
class AuthenticationService{
  ...
  static Future apple(String email, String token, String name) async {
    try {
      String url = '${Constants.baseUrl}apple/callback';
  ...
  static Future<bool> forgetPasswordVerifyOTP(String otp)async {
    try {
      String url = '${Constants.baseUrl}otp-verify';
  ...
  static Future<bool> resetPassword(String email, String password)async {
    try {
      String url = '${Constants.baseUrl}password-update';
