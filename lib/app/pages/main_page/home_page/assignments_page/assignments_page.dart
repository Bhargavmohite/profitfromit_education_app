...
class _AssignmentsPageState extends State<AssignmentsPage> with SingleTickerProviderStateMixin{
  ...
  static const String tag = "_AssignmentsPageState";
                                  ...
                                  Column(
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        height: 50,
                                        decoration: BoxDecoration(
                                          color: yellow29.withValues(alpha: .3),
                                  ...
                                  Column(
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        height: 50,
                                        decoration: BoxDecoration(
                                          color: green50.withValues(alpha: .3),
                                          shape: BoxShape.circle
                                        ),
                                        alignment: Alignment.center,
                                        ...
                                        child: Container(
                                          ...
                                          alignment: Alignment.center,
                                          child: SvgPicture.asset(AppAssets.checkSvg, colorFilter:  ColorFilter.mode(Colors.white.withValues(alpha: .6), BlendMode.srcIn), width: 10,)
                                        ),
                                      ),
                                  ...
                                  Column(
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        height: 50,
                                        decoration: BoxDecoration(
                                          color: red49.withValues(alpha: .3),
                                          shape: BoxShape.circle
                                        ),
                                        alignment: Alignment.center,
                                        ...
                                        child: Container(
                                          ...
                                          alignment: Alignment.center,
                                          child: SvgPicture.asset(AppAssets.clearSvg, colorFilter:  ColorFilter.mode(Colors.white.withValues(alpha: .6), BlendMode.srcIn), width: 9,)
                                        ),
                                      ),
