                ...
                children: [
                  ...
                  Expanded(
                    child: button(
                      ...
                      bgColor: Colors.transparent, 
                      textColor: filters.isEmpty ? green77().withValues(alpha: .35) : green77(),
                      borderColor: filters.isEmpty ? green77().withValues(alpha: .35) : green77(),
                      iconColor: filters.isEmpty ? green77().withValues(alpha: .35) : green77(),
                            ...
                            children: List.generate((isLoading && data.isEmpty) ? 8 : data.length, (index) {
                              ...
                              return (isLoading && data.isEmpty)
                                ...
                                : courseItemVertically(
                                    data[index],
                                    isShowReward: locator<FilterCourseProvider>().rewardCourse,
                                isFree: locator<FilterCourseProvider>().free,
                                token: token
                                  );
