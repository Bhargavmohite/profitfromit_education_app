...
class AssignmentWidget {
  static Widget assignmentItem(AssignmentModel assignment,
      {bool froUserRole = true}) {
    return GestureDetector(
      onTap: () {
        nextRoute(AssignmentOverviewPage.pageName,
            arguments: [assignment, froUserRole]);
      },
                  ...
                  child: Stack(
                    children: [
                      ClipRRect(
                          ...
                          child: fadeInImage(
                              assignment.webinarImage ?? '', 130, 85)),
                      if (froUserRole) ...{
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        froUserRole
                            ? timeStampToDateHour(
                                (assignment.deadlineTime ?? 0) * 1000)
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        froUserRole
                            ? assignment.userStatus == 'passed'
                                ? '${assignment.passGrade}/${assignment.totalGrade}'
                                : assignment.lastSubmission == null
                                    ? '-'
                                    : timeStampToDateHour(
                                        assignment.lastSubmission! * 1000)
