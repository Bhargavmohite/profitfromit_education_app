                    ...
                    child: Column(
                      children: [
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Container(
                                          constraints: BoxConstraints(maxWidth: getSize().width * .4, minWidth: getSize().width * .1),
                                          child: Text(
                                            token.isEmpty ? appText.webinar : '${appText.hi} $name ',
                        ...
                        AnimatedCrossFade(
                          ...
                          crossFadeState: (appBarAnimation.value < (150 + MediaQuery.of(navigatorKey.currentContext!).viewPadding.top)) ? CrossFadeState.showSecond : CrossFadeState.showFirst,
            ...
            return Scaffold(
              ...
              body: Column(
                ...
                children: [
                  directionality(
                    child: Container(
                      margin: EdgeInsets.only(bottom: MediaQuery.of(navigatorKey.currentContext!).viewInsets.bottom),
                      width: getSize().width,
                            ...
                            child: button(
                                onTap: () async {
                                  if (nameController.text.length > 3) {
                                    ...
                                    bool res = await AuthenticationService.registerStep3(userId, nameController.text.trim(), referralController.text.trim());
