  ...
  static Widget multiAnswerItem(Answer answer,bool isReview, {UserAnswer? userAnswer}){
    ...
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: borderRadius(),
        boxShadow: answer.isSelected ? [] : [boxShadow(Colors.black.withValues(alpha: .03), blur: 15, y: 3)],
        ...
        border: isReview
          ...
          : Border.all(color: answer.isSelected ? green77() : Colors.white.withValues(alpha: 0), width: 2.2),
