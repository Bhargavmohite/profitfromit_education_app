                ...
                Column(
                  children: [
                    ...
                    Container(
                      ...
                      height: 50,
                      decoration: BoxDecoration(
                        color: blueFE.withValues(alpha: .3),
                        shape: BoxShape.circle
                      ),
                      alignment: Alignment.center,
                ...
                Column(
                  children: [
                    ...
                    Container(
                      ...
                      height: 50,
                      decoration: BoxDecoration(
                        color: yellow4C.withValues(alpha: .3),
                        shape: BoxShape.circle
                      ),
                      alignment: Alignment.center,

                      child: SvgPicture.asset(AppAssets.walletSvg, colorFilter:  ColorFilter.mode(yellow4C.withValues(alpha: .6), BlendMode.srcIn), width: 20,),
                    ),
